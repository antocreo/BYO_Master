...
/*
 this is how I create the GUI. There are several ways to approach the GUI using this addon. I have chosen to create independent folders (f1,f2), 2 plotters and a dropdown.
 the elements are added, updated and then drawn.
 THe event activates a boolean which controls the events on the stage.
...
//    dropdown->expand();
    ...
    f1->setBackgroundColor(ofColor(190,80,10) );
    f2->setBackgroundColor(ofColor(29,140,4) );
    dropdown->setBackgroundColor(ofColor(150,40,96));
...
//        cout << bRecordTXT << endl;
    ...
    if (e.target->getLabel()=="activate SOUND") {
        bActivateSound = !bActivateSound;
    }
